  ...
  <div class="row">
    <div class="col-6 offset-3 bgc-white shadow radius-1 overflow-hidden py-5">
      <div class="mh-100">
        <div class="row justify-content-center">
          <div class="col-12 mt-2">
            <img class="mx-auto d-block" src="{{ url('assets') }}/image/Coffe-Shop.png" alt="LOGO {{ config.appName }}" style="height: 200px; border-radius: 8px" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-12 mt-2">
            <div class="text-center font-bold fa-2x" style="color: #693f3f">
              {{ config.appName }}
              <h6>{{ config.appDescription }}</h6>
            </div>
          </div>
        </div>
      ...
      <form autocomplete="off" class="form-row mt-4" method="post">
        ...
        <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
          <button type="submit" class="btn text-white btn-block px-4 btn-bold mt-2 mb-4" style="background-color: #693f3f">Sign In</button>
        </div>
      </form>
    </div>
  </div>
