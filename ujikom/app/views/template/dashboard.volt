...
<html lang="en" style="--scrollbar-width:16px; --moz-scrollbar-thin:16px; font-size: 0.7rem;">
	...
	<head>
		...
		<link rel="icon" id="fav_icon"type="image/png" href="{{ url('assets') }}/image/Coffe-Shop.png"/>
	...
	<body>
		...
		<div class="sidebar d-none">
			...
			<div class="body-container">
				<!-- Navbar -->
				<nav class="navbar navbar-sm navbar-expand-lg navbar-fixed " style="background-color: #693f3f;">
					<div
								...
								<ul
									...
									<li class="nav-item user user-menu">
										...
										<div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3 py-1">
											...
											<a class="dropdown-item btn btn-outline-grey bgc-h-secondary-l3 btn-h-light-secondary btn-a-light-secondary" href="{{ url('panel/auth/login') }}">
