...
<html lang="en">
  <head>
    ...
    #}
    <link rel="icon" type="image/png" href="{{ url('assets') }}/image/Coffe-Shop.png" />
  ...
  <body>
    <div class="body-container">
      <div class="main-container container bgc-transparent">
        <div class="main-content minh-100 justify-content-center">{% block content %} {% endblock %}</div>
      </div>
    </div>
    ...
    {% block scripts %} {% endblock %} {% block inline_script %} {% endblock %}
